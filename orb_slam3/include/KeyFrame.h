...
public:
    ...
    void AddAllPoint(MapPoint* pMP, const size_t &idx);
    void EraseMapPointMatch(const int &idx);
    void EraseMapPointMatch(MapPoint* pMP);
    void ReplaceMapPointMatch(const int &idx, MapPoint* pMP);
    std::set<MapPoint*> GetMapPoints();
    std::set<MapPoint*> GetAllPoints();
    std::vector<Eigen::Vector3f> Getx3D();
...
protected:
    ...
    // AllPoints associated to all point in frame
    std::vector<MapPoint*> mvpAllPoints;
    std::vector<Eigen::Vector3f> mvpx3D;
